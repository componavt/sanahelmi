...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, DB_VERSION)  {
    ...
    private fun copyDBFile() {
        ...
        //val mInput: InputStream = mContext.resources.openRawResource(R.raw.vepkar)
        //mContext.resources.getIdentifier("vepkar", "raw", mContext.packageName)
    ...
    companion object {
        private const val DB_NAME = "datas.db"
        private var DB_PATH = ""
